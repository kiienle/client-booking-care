...
class DoctorSchedule extends Component {
    ...
    handleCloseModal = () => {
        this.setState({
            isCloseModalBooking: !this.state.isCloseModalBooking,
        });
    };
    render() {
        let { allDays, allAvailableTime, isShowModalBooking } = this.state;
        let { language } = this.props;
        return (
            <>
                <BookingModal
                    ...
                    <div className="all-available-time">
                        <div className="schedule-calendar">
                            ...
                            {allAvailableTime && allAvailableTime.length > 0 && (
                                <div>
                                    Chọn <i class="fas fa-hand-point-up"></i> và
                                    đặt (Phí đặt lịch 0<sup>đ</sup>)
                                </div>
                            )}
                        </div>
                    </div>
