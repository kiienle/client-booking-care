...
class DoctorDetail extends Component {
    ...
    render() {
        ...
        let nameVi = positionDoctor.valueVi
            ? `${positionDoctor.valueVi} ${doctorDetail.firstName} ${doctorDetail.lastName}`
            : "";
        let nameEn = positionDoctor.valueEn
            ? `${positionDoctor.valueEn} ${doctorDetail.lastName} ${doctorDetail.firstName}`
            : "";
