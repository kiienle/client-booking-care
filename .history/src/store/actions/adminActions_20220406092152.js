...
export const getRequiredDoctorInforSuccess = (
    pricesData,
    paymentsData,
    provincesData
) => ({
    type: actionTypes.GET_REQUIRE_DOCTOR_INFOR_SUCCESS,
    pricesData,
    paymentsData,
    provincesData,
});
export const getRequiredDoctorInforFailed = () => ({
    type: actionTypes.GET_REQUIRE_DOCTOR_INFOR_FAILED,
});
