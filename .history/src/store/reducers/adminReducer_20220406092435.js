...
const adminReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case actionTypes.GET_REQUIRE_DOCTOR_INFOR_SUCCESS:
            copyState.prices = action.pricesData;
            copyState.payments = action.paymentsData;
            copyState.provinces = action.provincesData;
            return {
                ...copyState,
            };
        case actionTypes.GET_REQUIRE_DOCTOR_INFOR_FAIDED:
            copyState.prices = [];
            return {
                ...copyState,
            };
